...
function Header() {
  ...
  return (
    <header className="header fixed backdrop-blur-sm top-0 left-0 z-5 flex h-10 w-full items-center bg-white px-2 transition-[box-shadow,background-color] duration-[200ms,900ms] md:h-15 md:px-4">
