...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 z-5 flex h-10 w-full items-center bg-white px-2 md:h-15 md:px-4">
      <div className="mx-auto flex max-w-[1100px] flex-1 items-center justify-between">
        <div className="flex cursor-pointer items-center gap-2 select-none">
          <span className="grid size-[25px] md:size-[30px] place-items-center rounded-md md:rounded-lg bg-emerald-400 text-white">
